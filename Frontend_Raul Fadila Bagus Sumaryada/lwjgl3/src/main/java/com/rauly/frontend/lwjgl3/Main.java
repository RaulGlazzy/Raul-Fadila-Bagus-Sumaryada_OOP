...
import com.rauly.frontend.Ground;
import com.rauly.frontend.commands.Command;
import com.rauly.frontend.commands.JetpackCommand;
import com.rauly.frontend.commands.RestartCommand;
import com.rauly.frontend.factories.ObstacleFactory;
import com.rauly.frontend.observers.ScoreUIObserver;
import com.rauly.frontend.obstacles.BaseObstacle;
import com.rauly.frontend.obstacles.HomingMissile;
public class Main extends Game {
    ...
    // Background
    // TODO: Declare Background object here
    // TODO: Declare Command object for jetpack and restart
    // TODO: Declare a ScoreUIObserver object
    // Obstacle spawning
    ...
    private static final float SPAWN_AHEAD_DISTANCE = 300f; // Distance ahead of camera to


    spawn
    private static final float MIN_OBSTACLE_GAP = 200f; // Minimum gap between obstacle
    clusters
    ...
    public void create() {
        ...
        ground = new Ground();
        // TODO: Initialize jetpackCommand and restartCommand objects
        // TODO: Initialize scoreUIObserver object
        // TODO: Register scoreUIObserver to gameManager as an observer
        // TODO: Initialize background object
    ...
    private void update(float delta) {
        // TODO: Call execute() on jetpackCommand if SPACE key is pressed
        // Check if player is dead and wants to restart
        if (player.isDead()) {
            // TODO: Call execute() on restartCommand if SPACE key was just pressed
            return;
        }
    ...
    private void renderGame(ShapeRenderer shapeRenderer) {
        ...
        // TODO: Initialize spriteBatch if it is still null
        // TODO: Set the projection matrix for spriteBatch to match the camera
        // TODO: Background image using spriteBatch (between begin() and end())
        ...
        shapeRenderer.end();
        // TODO: Render score UI using scoreUIObserver, use score from gameManager
    }
    ...
    public void dispose() {
        ...
        // TODO: Call dispose() on scoreUIObserver
        // TODO: Call dispose() in the background
    }
}
